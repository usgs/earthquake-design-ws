...
var ASCE7Handler = require('../src/lib/asce7-handler'),
...
describe('asce7-handler', () => {
  ...
  describe('checkParams', () => {
    ...
    beforeEach(() => {
      handler = ASCE7Handler({factory: _DESIGN_FACTORY});
    });
