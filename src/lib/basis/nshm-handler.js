...
const DesignCategoryFactory = require('../component/design-category-factory'),
    extend = require('extend'),
    MetadataFactory = require('../component/metadata-factory'),
    NumberUtils = require('../util/number-utils').instance,
    SpectraFactory = require('../component/spectra-factory'),
...
const _DEFAULTS = {
  ...
  referenceDocument: 'NSHM' // not real
};


/**
 * Base Handler for web services validates parameters and calls
 * factory with params.
 *
 * @param options {Object}
 *    Configuration options
 */
const NSHM_Handler = function (options) {
  let _this,
      _initialize;
      ...
      try {
        ...
        resolve({
          data: {
            ...
            fa_note: siteAmplification.fa_note,
            ...
            fv_note: siteAmplification.fv_note,
