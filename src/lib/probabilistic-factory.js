...
var ProbabilisticFactory = function (options) {
  var _this,
      _initialize;
...
ProbabilisticFactory.QUERY_DATA = _QUERY_DATA;
ProbabilisticFactory.QUERY_DOCUMENT = _QUERY_DOCUMENT;
ProbabilisticFactory.QUERY_REGION = _QUERY_REGION;


module.exports = ProbabilisticFactory;
